...
|:---|:---|:---:|
| 🎯 **AWS Certified AI Practitioner** | Amazon Web Services | 🔄 Preparando |
| 📊 **Engenharia de Dados** (Especialização) | IBM (Coursera) | 🔄 Cursando |
| 🔐 **Segurança Cibernética** | Google (Coursera) | 🔄 Cursando |
| 🤖 **Aprendizado de Máquina** | DeepLearning.AI & Stanford Online | 🔄 Cursando |
| 📋 **Gerenciamento de Produtos de Software** | Universidade de Alberta | 🔄 Cursando |
| 💼 **Autogerenciamento** | Harvard Business Impact | 🔄 Cursando |

</details>

<details>
<summary><b>✅ Concluídas</b> — <i>clique para expandir</i></summary>
<br/>

| Certificação | Instituição | Carga Horária |
|:---|:---|:---:|
| 🏆 **Liderança de Alta Performance** | USP (ESALQ) | 8h |
| 🤖 **Intro Machine Learning com Python** | USP (ESALQ) | 8h |
...
| 💻 **Fundamentos de Lógica de Programação** | Fundação Bradesco | 15h |
| 💻 **Introdução à POO** | Fundação Bradesco | 5h |
| 🔄 **Metodologias Ágeis & Versionamento** | DIO | 15h |
...
<details>
<summary><b>📋 Disciplinas Concluídas</b> — <i>clique para expandir</i></summary>
<br/>
